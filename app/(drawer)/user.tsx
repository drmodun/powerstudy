...
export default function User() {
    ...
    const pickImage = async () => {
        ...
        if (result.assets !== null) uploadImage(result.assets[0].uri);
    };
    ...
    useEffect(() => {
        const load = () => {
            AsyncStorage.getItem('name').then((_name) =>
                setUsername2(_name as string)
            );
            AsyncStorage.getItem('email').then((_email) =>
        ...
        <SafeAreaView style={styles.wrapper}>
            ...
            <View style={styles.buttonWrapper}>
                <TouchableOpacity
                    ...
                    style={[
                        styles.button,
                        { backgroundColor: 'red', marginBottom: 8 },
                    ]}
                >
